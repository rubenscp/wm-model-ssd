...
def inference_neural_network_model(parameters, device, model):
    ...
    # sheet_list.append(['TP per classes', inference_metric.tp_per_class])
    # sheet_list.append(['FP per classes', inference_metric.fp_per_class])
    # sheet_list.append(['FN per classes', inference_metric.fn_per_class])
    # sheet_list.append(['TN per classes', inference_metric.tn_per_class])
    # sheet_list.append(['', ''])
