...
class Metrics:
    ...
    def set_image_target_prediction(self, image_name, targets, predictions):
        item = {
    ...
    def compute_confusion_matrix(self, num_classes, iou_threshold):
        ...
        logging_info(f'self.target: {self.target}')
        ...
        xxxxx = zip(self.preds, self.target)
        logging_info(f'xxxxx: {xxxxx}')
